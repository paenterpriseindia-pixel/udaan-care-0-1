...
export default function HowItWorksSection() {
  ...
  return (
    <section ref={sectionRef} style={{ padding: "120px 0", background: "var(--color-bg)" }}>
      <div className="container">
        ...
        <div style={{ maxWidth: 520, marginBottom: 72 }}>
          ...
          <motion.h2
            ...
            style={{ fontFamily: "'Nunito',sans-serif", fontWeight: 800, fontSize: "clamp(28px,4vw,42px)", color: "var(--color-text-primary)" }}
          >
